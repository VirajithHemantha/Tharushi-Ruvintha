        ...
        <div className="lg:w-1/2 relative z-10 w-full">
          ...
          >
            ...
            <p className="text-stone-500/90 font-serif text-lg sm:text-xl leading-relaxed mb-16 max-w-lg">
              We are honored to invite you to witness our union as we exchange vows, surrounded by the grace of God and the warmth of our loved ones.
            </p>
            ...
            <div className="relative space-y-12 ml-10 sm:ml-12 border-l-[1.5px] border-brand-beige/30 pl-10 sm:pl-12 py-4">
              ...
              <div className="relative group">
                ...
                <div>
                  ...
                  <p className="text-stone-600/90 text-base sm:text-lg font-serif mb-1">
                    <span className="font-bold">Time:</span> 4.00 p.m
                  </p>
                  <p className="text-stone-600/90 text-base sm:text-lg font-serif">
                    <span className="font-bold">Venue:</span> Our Lady of Sorrows church Nainamadama
                  </p>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div>
                  ...
                  <p className="text-stone-600/90 text-base sm:text-lg font-serif mb-1">
                    <span className="font-bold">Time:</span> 7.00 p.m
                  </p>
                  <p className="text-stone-600/90 text-base sm:text-lg font-serif">
                    <span className="font-bold">Venue:</span> Suriya resort Waikkal
                  </p>
                </div>
              </div>
        ...
        <div className="lg:w-1/2 w-full relative mt-16 lg:mt-0">
          ...
          >
            ...
            <div className="relative aspect-[3/4] sm:aspect-[4/5] rounded-[2rem] sm:rounded-[3rem] overflow-hidden border-[6px] sm:border-[8px] border-white shadow-[0_20px_50px_rgba(176,137,104,0.2)] bg-white group">
              <img
                src="/images/WhatsApp Image 2026-07-16 at 20.09.11.jpeg"
                loading="eager"
                decoding="async"
                onError={(e) => {
