  ...
  return (
    ...
    >
      ...
      <DeferredMount active={active} delay={240} minHeight="40vh">
        <div className="py-12 sm:py-32 bg-gradient-to-b from-white via-brand-champagne/30 to-brand-ivory relative overflow-hidden">
      ...
      <DeferredMount active={active} delay={520}>
        <footer className="py-12 bg-white border-t border-brand-beige/20 text-center relative overflow-hidden mt-10">
          ...
          <p className="font-display text-4xl sm:text-5xl text-stone-800 mb-2">Tharushi & Ruvintha</p>
