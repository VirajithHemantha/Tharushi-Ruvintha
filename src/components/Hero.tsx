...
export const Hero: React.FC<HeroProps> = ({ event = 'both' }) => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-[100dvh] flex items-center justify-center overflow-hidden bg-brand-ivory/30">
        ...
        >
          ...
          <div className="relative mb-6 sm:mb-12 w-full flex justify-center py-4 sm:py-10 px-2 overflow-visible">
            ...
            <h1 className="relative text-5xl sm:text-[7.5rem] lg:text-[10.5rem] font-display bg-gradient-to-r from-stone-900 via-brand-mocha to-stone-900 bg-clip-text text-transparent font-extrabold leading-normal sm:leading-[0.85] drop-shadow-[0_4px_16px_rgba(255,255,255,0.9)] tracking-normal sm:tracking-tight overflow-visible py-2">
              Tharushi <br className="sm:hidden" />
          ...
          <div className="inline-block relative group mt-2 sm:mt-6 w-full sm:w-auto px-4 sm:px-0">
            ...
            <div className="relative px-8 sm:px-16 py-4 sm:py-6 bg-brand-ivory/95 backdrop-blur-2xl border border-brand-gold/50 rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden whitespace-nowrap flex items-center justify-center transition-transform duration-500 group-hover:scale-[1.02]">
              <div className="absolute inset-0 bg-gradient-to-b from-white/40 to-transparent pointer-events-none" />
              <span className="relative text-[17px] sm:text-3xl font-serif text-stone-900 tracking-[0.25em] sm:tracking-[0.45em] font-bold drop-shadow-sm flex items-center gap-3 sm:gap-4 whitespace-nowrap">
      ...
      >
        <span className="text-[9px] sm:text-[10px] font-sans uppercase tracking-[0.5em] text-stone-900 font-extrabold bg-gradient-to-r from-brand-champagne via-white to-brand-champagne px-5 py-2 rounded-full border border-brand-gold/40 backdrop-blur-md shadow-lg">
          Discover
        </span>
